...
import_bpe1 <- function(file){
  data <- read_csv2(file) %>% filter(TYPEQU %in% c("D101", "D102", "D103", "D104", "D105", "D106", "D401")) %>%
    group_by(DEPCOM, AN, TYPEQU) %>% summarise(nb = sum(NB_EQUIP)) %>%
    ungroup %>%
    pivot_wider(names_from = TYPEQU, values_from = nb) %>%
    rename(CODGEO = DEPCOM, NB_D101 = D101, NB_D102 = D102, NB_D103 = D103, NB_D104 = D104, NB_D105 = D105,  NB_D106 = D106, NB_D401 = D401, annee = AN) %>%
...
import_bpe2 <- function(file){
  ...
  data <- read_csv2(file) %>% select(CODGEO, NB_D101, NB_D102, NB_D103, NB_D104, NB_D105, NB_D106, NB_D401) %>%
    mutate(annee = !!annee)
}
...
write_csv(bpe, "~/ENSAE/3A/Projet_DSSS/Données/bpe_tvs.csv")
...
fixed <- feols(age_moyen_deces ~ densite + log_pop + taille_menage + med_niveau_vie + NB_D401 + NB_D106 +
                 ...
                 CSagriculteurs + CSretraites + F30_44 + F45_59 + F60_74 + Fplus75 + Fpop_tot + `15_29` +
                 `30_44` + `45_59` + `60_74` + plus75 + F15_29 + as.factor(annee)
...
fixed <- feols(log_morts ~ densite + log_pop + taille_menage + med_niveau_vie + NB_D401 + NB_D106 +
                 NB_D101 + NB_D102 + NB_D103 + NB_D104 + NB_D105 + CSprof_interm + CScadres +
                 CSemployes + CSouvriers + CSartisans_commercants + CSagriculteurs + CSretraites + F30_44 + 
                 F45_59 + F60_74 + Fplus75 + Fpop_tot + `15_29` + `30_44` + `45_59` + `60_74` + plus75 + F15_29 + as.factor(annee)
               | code_tvs, data=data_tvs %>% filter(!is.na(taille_menage)))
summary(fixed)

fixed <- feols(log_morts_jeunes ~ densite + log_pop + taille_menage + med_niveau_vie + NB_D401 + NB_D106 +
                 NB_D101 + NB_D102 + NB_D103 + NB_D104 + NB_D105 + CSprof_interm + CScadres +
                 CSemployes + CSouvriers + CSartisans_commercants + CSagriculteurs + CSretraites + F30_44 + 
                 F45_59 + F60_74 + Fplus75 + Fpop_tot + `15_29` + `30_44` + `45_59` + `60_74` + plus75 + F15_29 + as.factor(annee)
               | code_tvs, data=data_tvs %>% filter(!is.na(taille_menage)))
...
fixed <- feols(log_morts_vieux ~ densite + log_pop + taille_menage + med_niveau_vie + NB_D401 + NB_D106 +
                 NB_D101 + NB_D102 + NB_D103 + NB_D104 + NB_D105 + CSprof_interm + CScadres +
                 CSemployes + CSouvriers + CSartisans_commercants + CSagriculteurs + CSretraites + F30_44 + 
                 F45_59 + F60_74 + Fplus75 + Fpop_tot + `15_29` + `30_44` + `45_59` + `60_74` + plus75 + F15_29 + as.factor(annee)
               | code_tvs, data=data_tvs %>% filter(!is.na(taille_menage)))
...
fixed <- feols(part_jeunes ~ densite + log_pop + taille_menage + med_niveau_vie + NB_D401 + NB_D106 +
                 NB_D101 + NB_D102 + NB_D103 + NB_D104 + NB_D105 + CSprof_interm + CScadres +
                 CSemployes + CSouvriers + CSartisans_commercants + CSagriculteurs + CSretraites + F30_44 + 
                 F45_59 + F60_74 + Fplus75 + Fpop_tot + `15_29` + `30_44` + `45_59` + `60_74` + plus75 + F15_29 + as.factor(annee)
               | code_tvs, data=data_tvs %>% filter(!is.na(taille_menage)))
...
fixed <- feols(part_vieux ~ densite + log_pop + taille_menage + med_niveau_vie + NB_D401 + NB_D106 +
                 NB_D101 + NB_D102 + NB_D103 + NB_D104 + NB_D105 + CSprof_interm + CScadres +
                 CSemployes + CSouvriers + CSartisans_commercants + CSagriculteurs + CSretraites + F30_44 + 
                 F45_59 + F60_74 + Fplus75 + Fpop_tot + `15_29` + `30_44` + `45_59` + `60_74` + plus75 + F15_29 + as.factor(annee)
               | code_tvs, data=data_tvs %>% filter(!is.na(taille_menage)))
